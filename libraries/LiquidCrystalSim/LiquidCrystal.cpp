...
void LiquidCrystal::noCursor() {
  if (Sim_Rij == "tx2") {
    Sim_Rij = "tx2";
    Serial.print("CUN2222");
  }else {
    Sim_Rij = "tx1";
    Serial.print("CUN1111");
  }
  delay(10);  
  Serial.print('\n'); 
  delay(10);  // pause 10ms
...
//print
void LiquidCrystal::print(char text){
  Serial.print("PRC1111"); 
  delay(10);  
  Serial.print('\n'); 
  delay(30);  // pause 30ms 
  if (Sim_Rij == "tx2") {
  ...
  Serial.print(Sim_Rij + Sim_Data0);    //Serial.print(Sim_Rij + Sim_Data0); 
  delay(10);  
  Serial.print('\n'); 
  delay(30);  // pause 30ms 
}

void LiquidCrystal::print(int text){
  Serial.print("PRC1111"); 
  delay(10);  
  Serial.print('\n'); 
  delay(30);  // pause 30ms 
...
void LiquidCrystal::print(String text){
  ...
  Serial.print(Sim_Rij + text);     // Serial.print(Sim_Rij + text);
  delay(10);  
  Serial.print('\n'); 
  delay(30);  // pause 30ms   
}

void LiquidCrystal::print(unsigned long text){
...
void LiquidCrystal::write(char text){
...
void LiquidCrystal::write(int text){
  Serial.print("YWR1111");
  delay(10);  
  Serial.print('\n'); 
  delay(30);  // pause 10ms 
  ...
  delay(30);  // pause 30ms 
  char Chartxt = text;
  Serial.print(Sim_Rij + Chartxt);     // Serial.print(Sim_Rij + text);
  delay(10);  
  Serial.print('\n'); 
  delay(30);  // pause 30ms  
}
